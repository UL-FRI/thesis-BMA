...
% ----------------------------------------------------------
% Adjust the thesis language, your study program and course
% ---------------------------------------------------------
% switch language
...
% switch on if your program is divided into courses CS and DS, otherwise leave it false
% \COURSEEXISTfalse
\COURSEEXISTtrue

% default course name is "Computer science" if your course name is "Data science", set the following switch to false
\COURSECStrue % uncomment if the thesis is from course "Information science"
%\COURSECSfalse % uncomment if the thesis is from course "Data Science"
% ----------------------------------------------------------
