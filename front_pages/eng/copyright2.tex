...
\vspace*{1.5cm}
{\small \noindent
The provided source code of the thesis, its results, and the software developed for this purpose are licensed under the GNU General Public License, version 3 (or later). This means they may be freely distributed and/or modified under its terms. Details of the license are available on the website at \url{http://www.gnu.org/licenses/}.
}
